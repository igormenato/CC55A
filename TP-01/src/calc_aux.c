...
{
    struct ufuncall *a = malloc(sizeof(struct ufuncall));
...
static double calluser(struct ufuncall *);
...
double eval(struct ast *a)
{
    ...
    case 'C': v = calluser((struct ufuncall *)a); break;
...
static double calluser(struct ufuncall *f)
{
    ...
    /* prepara-se para salvar argumentos */
